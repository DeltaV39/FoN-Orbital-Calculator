...
burn_AOE_label = ttk.Label(metrics_frame, textvariable = burn_AoE)
burn_AOE_label.grid(column = 1, row = 4)
ttk.Label(metrics_frame, text="⁰").grid(column = 2, row = 4)

ttk.Label(metrics_frame, text = "Burn deltaV").grid(column = 0, row = 5)
burn_deltaV_label = ttk.Label(metrics_frame, textvariable = burn_deltav)
burn_deltaV_label.grid(column = 1, row = 5)
ttk.Label(metrics_frame, text="m/s").grid(column = 2, row = 5)

ttk.Label(metrics_frame, text = "Post burn FPA").grid(column = 0, row = 6)
burn_FPA_label = ttk.Label(metrics_frame, textvariable = after_FPA)
burn_FPA_label.grid(column = 1, row = 6)
ttk.Label(metrics_frame, text="⁰").grid(column = 2, row = 6)

ttk.Label(metrics_frame, text = "Post burn speed").grid(column = 0, row = 7)
burn_speed_label = ttk.Label(metrics_frame, textvariable = after_speed)
burn_speed_label.grid(column = 1, row = 7)
